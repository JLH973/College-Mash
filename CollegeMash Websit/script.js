...
function changeText1() {
    ...
    name1txt.innerHTML = names[rand1]+"&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
    name2txt.innerHTML = "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+names[rand2];
...
function setScore(rand1, rand2) {
    let score1txt = document.getElementById("picker").getElementsByClassName("score1Label")[0];
    let score2txt = document.getElementById("picker").getElementsByClassName("score2Label")[0];
    score1txt.innerHTML = scores[rand1]+"&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
    score2txt.innerHTML = "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+scores[rand2];
}